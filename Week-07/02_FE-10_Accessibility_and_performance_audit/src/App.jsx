    ...
    <div className="app" style={{ '--theme-bg': theme.bg }}>
      ...
      <main>
        <section className="hero-stage">
          <div className="hero-stage__canvas" role="img" aria-label={`Animated 3D scene: a glowing, distorted crystal-like core in ${theme.name} colors, orbited by faint rings and drifting particles.`}>
          ...
          <div className="hero-stage__content">
            ...
            <div className="hero__cta-row">
              <button
                type="button"
                className="hero__cta-hint"
                onClick={handleAdvanceTheme}
                aria-label={`Currently in ${theme.name} mode. Activate to change the color theme.`}
              >
                <span className="hero__cta-dot" style={{ background: theme.glow }} aria-hidden="true" />
                Currently in <strong>{theme.name}</strong> mode — click to change it
              </button>
            </div>
        ...
        <section className="guide" aria-labelledby="guide-heading">
          <h2 id="guide-heading" className="sr-only">How to interact with the scene</h2>
